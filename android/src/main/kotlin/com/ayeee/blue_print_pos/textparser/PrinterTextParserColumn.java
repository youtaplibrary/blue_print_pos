...
public class PrinterTextParserColumn {
    ...
    private void appendString(String text) {
        PrinterTextParser textParser = this.textParserLine.getTextParser();
        this.appendString(text, textParser.getLastTextSize(), textParser.getLastTextColor(), textParser.getLastTextReverseColor(), textParser.getLastTextBold(), textParser.getLastTextUnderline(), textParser.getLastTextDoubleStrike());
    }

    private void appendString(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor, byte[] textBold, byte[] textUnderline, byte[] textDoubleStrike) {
        this.appendElement(new PrinterTextParserString(this, text, textSize, textColor, textReverseColor, textBold, textUnderline, textDoubleStrike));
    }
    ...
    private void appendImage(String textAlign, String hexString) {
        this.appendElement(new PrinterTextParserImg(this, textAlign, hexString));
    }
    ...
    private void appendBarcode(String textAlign, Hashtable<String, String> barcodeAttributes, String code) throws EscPosParserException, EscPosBarcodeException {
        this.appendElement(new PrinterTextParserBarcode(this, textAlign, barcodeAttributes, code));
    }
    ...
    private void appendQRCode(String textAlign, Hashtable<String, String> qrCodeAttributes, String data) throws EscPosParserException, EscPosBarcodeException {
        this.appendElement(new PrinterTextParserQRCode(this, textAlign, qrCodeAttributes, data));
    }
    ...
    private void appendElement(IPrinterTextParserElement element) {
        IPrinterTextParserElement[] elementsTmp = new IPrinterTextParserElement[this.elements.length + 1];
