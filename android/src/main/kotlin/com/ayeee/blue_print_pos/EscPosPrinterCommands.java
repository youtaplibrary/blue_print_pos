...
public class EscPosPrinterCommands {
    ...
    public void printAllCharsetsEncodingCharacters() {
        for (int charsetId = 0; charsetId < 256; ++charsetId) {
            this.printCharsetEncodingCharacters(charsetId);
        }
    }

    public void printCharsetsEncodingCharacters(int[] charsetsId) {
        for (int charsetId : charsetsId) {
            this.printCharsetEncodingCharacters(charsetId);
        }
    }

    public void printCharsetEncodingCharacters(int charsetId) {
     ...
     */
    public void useEscAsteriskCommand(boolean enable) {
     ...
     */
    public void printImage(byte[] image) throws EscPosConnectionException {
     ...
     * @param align Set the alignment of text and barcodes. Use EscPosPrinterCommands.TEXT_ALIGN_... constants
     */
    public void newLine(byte[] align) {
