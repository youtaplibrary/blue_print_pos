...
import 'package:esc_pos_utils/esc_pos_utils.dart' show CapabilityProfile, Generator, PaperSize;
...
class BluePrintPos {
  ...
  Future<void> printQR(
    ...
    await printReceiptImage(byteBuffer,
        width: size, feedCount: feedCount, useCut: useCut, openDrawer: openDrawer);
  }
